...
export default function AuthWrapperOne({
  ...
  return (
    <>
      ...
      <div className={`min-h-screen justify-between gap-x-8 px-4 py-8 pt-10 md:pt-12 lg:flex lg:p-6 xl:gap-x-10 xl:p-7 2xl:p-10 2xl:pt-10 [&>div]:min-h-[calc(100vh-80px)] ${className}`}>
